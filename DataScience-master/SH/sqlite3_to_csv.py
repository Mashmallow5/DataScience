...
with open('SH_User.csv','w') as out_csv_file:
...
with open('SH_Card.csv','w') as out_csv_file:
...
with open('SH_Flight.csv','w') as out_csv_file:
...
with open('SH_CardFlight.csv','w') as out_csv_file:
  ad_f_out = csv.writer(out_csv_file)
  # write header                        
  ad_f_out.writerow([d[0] for d in cur.description])
  # write data                          
